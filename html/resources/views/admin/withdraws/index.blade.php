...
const acceptPayout = id => {
    $('.btn-icon').css({pointerEvents: 'none'})

    $.post('/admin/withdraws/payout', {
        id
    })
    .then(response => {
        $('.btn-icon').css({pointerEvents: 'auto'})
...
const acceptParadiseSbpPayout = id => {
    $('.btn-icon').css({pointerEvents: 'none'})

    $.post('/admin/withdraws/acceptParadiseSbpPayout', {
        id
    })
    .then(response => {
        $('.btn-icon').css({pointerEvents: 'auto'})
...
const acceptCryptobotPayout = id => {
    $('.btn-icon').css({pointerEvents: 'none'})

    $.post('/admin/withdraws/acceptCryptobotPayout', {
        id
    })
    .then(response => {
        $('.btn-icon').css({pointerEvents: 'auto'})
...
const acceptFKPayout = id => {
    $('.btn-icon').css({pointerEvents: 'none'})

    $.post('/admin/withdraws/acceptFKPayout', {
        id
    })
    .then(response => {
        $('.btn-icon').css({pointerEvents: 'auto'})
