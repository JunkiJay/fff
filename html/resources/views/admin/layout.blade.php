                    ...
                    <ul class="kt-menu__nav ">
                                        ...
                                        <span class="kt-menu__link-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    ...
                                                    <path d="M15,14 C14.4477153,14 14,13.5522847 14,13 C14,12.4477153 14.4477153,12 15,12 C15.5522847,12 16,12.4477153 16,13 C16,13.5522847 15.5522847,14 15,14 Z M9,14 C8.44771525,14 8,13.5522847 8,13 C8,12.4477153 8.44771525,12 9,12 C9.55228475,12 10,12.4477153 10,13 C10,13.5522847 9.55228475,14 9,14 Z"
											...
											<svg xmlns="http://www.w3.org/2000/svg"
												...
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													...
													<path d="M14.4452998,2.16794971 C14.9048285,1.86159725 15.5256978,1.98577112 15.8320503,2.4452998 C16.1384028,2.90482849 16.0142289,3.52569784 15.5547002,3.83205029 L12,6.20185043 L8.4452998,3.83205029 C7.98577112,3.52569784 7.86159725,2.90482849 8.16794971,2.4452998 C8.47430216,1.98577112 9.09517151,1.86159725 9.5547002,2.16794971 L12,3.79814957 L14.4452998,2.16794971 Z"
                                                          id="Path-31" fill="#000000" fill-rule="nonzero"
                                                          opacity="0.3" />
												</g>
											</svg>
										</span>
                        ...
                        <li class="kt-menu__item {{ Request::is('admin/withdraws') ? 'kt-menu__item--active' : '' }}"
                            ...
                            <a href="{{ route('admin.withdraws') }}" class="kt-menu__link">
                                ...
                                <span class="btn-sm btn-success" style="margin-top: -2px;">{{
                                        \App\Models\Withdraw::where([['is_youtuber', 0], ['status', 0]])->count()
                                        }}</span>
                            </a>
                        </li>
                    ...
                    <div id="kt_header_menu"
                        ...
                        <ul class="kt-menu__nav ">
                            <li class="kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here">
                                <button type="button" class="btn btn-success versionUpdate">Обновить версию файлов
                                </button>
                            </li>
...
<div class="modal fade" id="multiChecker" tabindex="-1" role="dialog" aria-labelledby="newLabel" style="display: none;"
     aria-hidden="true">
            ...
            <form class="kt-form-new" action="#" id="save">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="list_multi" readonly disabled></textarea>
                    </div>
                </div>
            ...
            .then(response => {
                ...
                if (response.list.length !== 0) {
                    ...
                    response.list.map((item) => {
                        $('#list_multi').val((item.username + '(id:' + item.id + ')'))
                    })
