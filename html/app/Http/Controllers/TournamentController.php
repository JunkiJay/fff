...
class TournamentController extends Controller
{
    ...
    public function __construct()
    {
        try {
            ...
            // Если таблицы не существуют, используем значения по умолчанию
            $this->settings = null;
            $this->leaders = null;
        }
    }
    ...
    public function leaders()
    {
        return response()->json([
            'leaders' => $this->leaders ? $this->leaders->history_leaders : [],
            'places' => $this->settings ? $this->settings->places : []
        ]);
    }
    ...
    {
        return response()->json([
            'endDate' => $this->leaders ? $this->leaders->end_at : null,
        ]);
    }
