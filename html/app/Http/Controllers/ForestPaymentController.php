...
use App\Services\ForestPayment\ForestPaymentService;
...
class ForestPaymentController extends Controller
{
    private $paymentService;

    public function __construct(ForestPaymentService $paymentService)
    {
    ...
    public function createPayment(Request $request)
    {
        try {
            ...
            $paymentData = [
                'shop_id' => config('services.forest.merchand_id'),
                'invoice_id' => (string)$payment->id,
                'description' => $user->id,
                'amount' => $amount * 100,
                'method' => 'BankCard', //BankCard
                'country' => 'RU',
                'currency' => 'RUB',
