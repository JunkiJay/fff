...
var KTPortlet = function(elementId, options) {
            ...
            if (the.options.tooltips) {
                ...
                if (fullscreen) {
                    ...
                    var tip = new Tooltip(fullscreen, {
                        title: (fullscreenOn ? the.options.tools.isFullscreen.off : the.options.tools.isFullscreen.on),
                        placement: placement,
                        offset: (fullscreenOn ? '0,10px,0,0' : '0,5px'),
                        trigger: 'hover',
                        template: '<div class="tooltip tooltip-portlet tooltip bs-tooltip-' + placement + '" role="tooltip">\
     ...
     * @returns {MPortlet}
     */
    the.isFullscreen = function() {
        return Plugin.isFullscreen('on');
    };
    ...
    the.unFullscreen = function() {
        return Plugin.isFullscreen('off');
    };
