...
Route::group(['prefix' => 'payment'], function () {
    Route::post('62215stimulefk/handle', 'PaymentController@handle');
});
...
Route::post('/callback/skfd1plat', 'PaymentController@callback1plat');
...
// CryptoBot
Route::post('/callback/cryptobot/3eewgkjw74sd', 'PaymentController@callbackCryptobot');
