                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12" style="margin-bottom:2rem;">
                                        ...
                                        <select class="form-control" name="antiminus">
                                            <option value="1" @if($settings->antiminus == 1) selected @endif>Включен
                                            </option>
                                            <option value="0" @if($settings->antiminus == 0) selected @endif>Отключен
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" placeholder=""
                                               value="{{\App\Models\Profit::query()->find(1)->bank_dice}}"
                                               name="bank_dice" />
                                    </div>
                                    <div class="col-lg-4">
                                        <label>Банк в Plinko:</label>
                                        <input type="text" class="form-control" placeholder=""
                                               value="{{\App\Models\Profit::query()->find(1)->bank_plinko}}"
                                               name="bank_plinko" />
                                    </div>
                                    <div class="col-lg-4">
                                        <label>Банк в Mines:</label>
                                        <input type="text" class="form-control" placeholder=""
                                               value="{{\App\Models\Profit::query()->find(1)->bank_mines}}"
                                               name="bank_mines" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" placeholder=""
                                               value="{{\App\Models\Profit::query()->find(1)->bank_bubbles}}"
                                               name="bank_bubbles" />
                                    </div>
                                    <div class="col-lg-4">
                                        <label>Банк в Wheel:</label>
                                        <input type="text" class="form-control" placeholder=""
                                               value="{{\App\Models\Profit::query()->find(1)->bank_wheel}}"
                                               name="bank_wheel" />
                                    </div>
                                    <div class="col-lg-4">
                                        <label>Комиссия в банк сайта:</label>
                                        <input type="text" class="form-control" placeholder=""
                                               value="{{\App\Models\Profit::query()->find(1)->comission}}"
                                               name="comission" />
                                    </div>
                                </div>
                            </div>
